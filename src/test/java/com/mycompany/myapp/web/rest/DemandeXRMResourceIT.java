...
class DemandeXRMResourceIT {
    ...
    private static final LocalTime DEFAULT_RECEPTION_DATE = LocalTime.NOON;
    private static final LocalTime UPDATED_RECEPTION_DATE = LocalTime.MAX.withNano(0);
    ...
    public static DemandeXRM createEntity() {
        return new DemandeXRM().aI(DEFAULT_A_I).iVS(DEFAULT_I_VS).receptionDate(DEFAULT_RECEPTION_DATE).updated(DEFAULT_UPDATED);
    }
    ...
    public static DemandeXRM createUpdatedEntity() {
        return new DemandeXRM().aI(UPDATED_A_I).iVS(UPDATED_I_VS).receptionDate(UPDATED_RECEPTION_DATE).updated(UPDATED_UPDATED);
    }
    ...
    void putExistingDemandeXRM() throws Exception {
        ...
        updatedDemandeXRM.aI(UPDATED_A_I).iVS(UPDATED_I_VS).receptionDate(UPDATED_RECEPTION_DATE).updated(UPDATED_UPDATED);
    ...
    void partialUpdateDemandeXRMWithPatch() throws Exception {
        ...
        partialUpdatedDemandeXRM.aI(UPDATED_A_I).updated(UPDATED_UPDATED);
    ...
    void fullUpdateDemandeXRMWithPatch() throws Exception {
        ...
        partialUpdatedDemandeXRM.aI(UPDATED_A_I).iVS(UPDATED_I_VS).receptionDate(UPDATED_RECEPTION_DATE).updated(UPDATED_UPDATED);
