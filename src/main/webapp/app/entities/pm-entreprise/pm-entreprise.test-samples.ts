...
export const sampleWithRequiredData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-04-29'),
  dateEtat: dayjs('2025-04-29'),
  dateFermetureJuridique: dayjs('2025-04-30'),
  codeTrancheEffectif: 'gadzooks although muscat',
  libelleTrancheEffectif: 'trash plain',
  dateCessationActivite: dayjs('2025-04-29'),
  dateEffectifOfficiel: dayjs('2025-04-29'),
...
export const sampleWithPartialData: IPmEntreprise = {
  ...
  dateCreationJuridique: dayjs('2025-04-30'),
  dateEtat: dayjs('2025-04-30'),
  dateFermetureJuridique: dayjs('2025-04-29'),
  codeTrancheEffectif: 'whoever eek',
  libelleTrancheEffectif: 'an',
  dateCessationActivite: dayjs('2025-04-29'),
  dateEffectifOfficiel: dayjs('2025-04-30'),
...
export const sampleWithNewData: NewPmEntreprise = {
  ...
  dateCessationActivite: dayjs('2025-04-30'),
  dateEffectifOfficiel: dayjs('2025-04-29'),
